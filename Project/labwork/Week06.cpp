...
void VulkanBase::BeginRenderPass(const GP2CommandBuffer& buffer, VkFramebuffer currentBuffer, VkExtent2D extent)
{
	...
	clearValues[0].color = {{100.0f/255.0f, 100.0f / 255.0f, 100.0f / 255.0f, 1.0f}};
...
void VulkanBase::EndRenderPass(const GP2CommandBuffer& buffer)
{
